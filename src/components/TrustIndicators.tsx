  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-cerny-orange/10 to-cerny-navy/10 p-4 rounded-lg">
        <h3 className="font-semibold text-cerny-navy mb-3 flex items-center">
      ...
      <div className="text-center p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-sm text-gray-600">Based on 50+ verified reviews</p>
      </div>
      ...
      <div className="bg-cerny-orange/10 border border-cerny-orange/20 p-4 rounded-lg">
        <div className="flex items-center mb-2">
          ...
          <span className="font-semibold text-cerny-navy">Limited Availability</span>
        </div>
      ...
      <div className="text-center">
        <div className="flex justify-center items-center mb-2">
          ...
          <span className="font-semibold text-cerny-navy">Award-Winning Team</span>
        </div>
        <p className="text-sm text-gray-600">Northern Virginia's Top Remodeling Company 2023</p>
      </div>
    </div>
  );
};
