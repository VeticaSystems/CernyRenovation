      ...
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-cerny-navy mb-2">Years Experience</h3>
            <p className="text-gray-600 text-sm">Serving Northern Virginia since 2011</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-cerny-navy mb-2">Homes Transformed</h3>
            <p className="text-gray-600 text-sm">Happy families in beautiful spaces</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-cerny-navy mb-2">Licensed & Insured</h3>
            <p className="text-gray-600 text-sm">Fully bonded for your peace of mind</p>
          </div>
        </div>
      </div>
    </section>
